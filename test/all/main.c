...
main_initialize(void) {
	...
	application.name = string_const(STRING_CONST("Input library test suite"));
...
main_run(void* main_arg) {
	...
	log_infof(HASH_TEST, STRING_CONST("Input library v%s built for %s using %s (%s)"),
	          string_from_version_static(input_module_version()).str, FOUNDATION_PLATFORM_DESCRIPTION,
	...
	test_run_fn tests[] = {test_basic_run, 0};
